...
coqc -w none -R target CoqSwitchedSystems dependencies\coquelicot_extensions\matrix_extensions.v -o target\matrix_extensions.vo
coqc -w none -R target CoqSwitchedSystems dependencies\neural_networks\piecewise_affine.v -o target\piecewise_affine.vo
